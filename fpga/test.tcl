...
#
# test.tcl: Tcl script for re-creating project 'test'
#
# Generated by Vivado on Thu Jan 30 16:10:34 EST 2025
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/constr/pinout.xdc"]"\
...
if { [get_files top.v] == "" } {
  import_files -quiet -fileset sources_1 /home/hep/analog-photon-processor/fpga/test/test.srcs/sources_1/new/top.v
}
...
\
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins top_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins top_0/rst]
  connect_bd_net -net top_0_signal [get_bd_ports LED] [get_bd_pins top_0/signal]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-12,-81",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 3 -x 860 -y 140 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 3 -x 860 -y 160 -defaultsOSRD
preplace port port-id_LED -pg 1 -lvl 3 -x 860 -y 70 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y 220 -defaultsOSRD
preplace inst top_0 -pg 1 -lvl 2 -x 660 -y 70 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 660 -y 260 -defaultsOSRD
preplace netloc top_0_signal 1 2 1 NJ 70
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 480 80n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 10 80 470
preplace netloc processing_system7_0_FIXED_IO 1 1 2 NJ 160 NJ
preplace netloc processing_system7_0_DDR 1 1 2 NJ 140 NJ
levelinfo -pg 1 -10 240 660 860
pagesize -pg 1 -db -bbox -sgen -10 0 980 360
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/test.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
